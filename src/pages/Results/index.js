    ...
    if (movies) {
      ...
      return(
        <div className={classes.noResultsContainer}>
          <Typography className={classes.noResultsText}>No existing values</Typography>
          <Button variant="contained" color="primary" onClick={handleGoToHomeClick}>Go to home</Button>
        </div>
      )
    }else {
